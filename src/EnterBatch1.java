...
public class EnterBatch1 extends JFrame implements ActionListener{
	...
	Options op;
	Faculty fc;
	public EnterBatch1(Options op,Faculty fc){
		this.op=op;
		p=new JPanel();
		p.setLayout(null);
		setLocation(400,250);
		...
		if(ae.getActionCommand().equals("Cancel")){
			...
			try {
				...
				if(n1<=0){
				 ...
				 //JOptionPane.showMessageDialog(this, "Faculty Not  2 2 3Authorised to Update");
					BatchRecord ob=new BatchRecord(this,t1.getText());
					//JOptionPane.showMessageDialog(this, "Faculty Not  2 2 3Authorised to Update");
